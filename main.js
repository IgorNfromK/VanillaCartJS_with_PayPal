	...
	cart.forEach(cartItem => {
		...
		addToCartButtonsDOM.forEach(addToCartButtonDOM => {
			...
			if(productDOM.querySelector('.product__name').innerText === product.name) {
				...
				handleActionButton(addToCartButtonDOM, product);
			}
		});
	});
}
 ...
 function insertItemToDOM(product) {
	...
	cartDOM.insertAdjacentHTML('beforeend', 
		`<div class="cart__item">
		    ...
		    <h3 class="clart__item__price">${product.price}</h3>
	...
	function handleActionButton(addToCartButtonDOM, product) {
...
<input type="hidden" name="business" value="ccna4igor@gmail.com">
`;
